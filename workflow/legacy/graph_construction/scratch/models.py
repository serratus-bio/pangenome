...
class FuncDomainSet(RegionSet):
    ...
    hasclanhomology = RelationshipTo("FuncDomainSet", "hasClanHomology", cardinality=ZeroOrOne, model=HasclanhomologyRel) # self -> peer
    clanhomologyof = RelationshipTo("FuncDomainSet", "hasClanHomology", cardinality=ZeroOrOne, model=HasclanhomologyRel) # peer -> self
